...
function [f,newxt,newpath] = objfun_eNDM_general_costopts(param,seed_location,pathology,ts,C_,U_,solvetype_,costfun)
...
% Calculate predictions y with eNDM     
    % Solve eNDM; 
    [y] = eNDM_general(x0_,ts,C_,U_,alpha_,beta_,a_,b_,p_,solvetype_);
